...
class TeamAppView(APIView):
    ...
    @swagger_auto_schema(responses={
                             ...
                             CreateTeamAppResponseSerializer})
    def post(self, request, team_id):
        ...
        response_data = CreateTeamAppResponseSerializer(
            data={"response_data": CreateTeamAppInnerResponse(
                id=application.id,
    ...
    def get(self, request, team_id):
        ...
        inner_response = {"team_id": team_id, "applications": applications_data.data}
        inner_response = GetTeamAppInnerResponse(data=inner_response)
        response_data = GetTeamAppResponseSerializer(response_data=inner_response)
        response_data.is_valid()
